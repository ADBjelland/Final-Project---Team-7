...
# -*- coding: utf-8 -*-
"""
Created on Mon May  2 22:51:12 2022
...
InputFileName = "Final Project Input File - DebugDemo.csv"   #Read input csv file

# Normal/Uniform/Positive
InputRow = 4
DEBUG_Setting = 2

# # Parallel/Nonuniform/Negative
# InputRow = 5
# DEBUG_Setting = 2

# # UnacceptedEntry: Bracing Orientation: Perpindicular is not in ['Parallel', 'Normal']
# InputRow = 6
# DEBUG_Setting = 0 # data check only

# # ListLengthError: Steel must be List of Length 4
# InputRow = 7
# DEBUG_Setting = 0 # data check only

# # DataError: # of Girders and Girder Spacing not Compatible
# InputRow = 8
# DEBUG_Setting = 2

# # DataError: Bracing Length (630.0) >= Girder Length (600.0)
# InputRow = 9
# DEBUG_Setting = 1 # inspect visually
